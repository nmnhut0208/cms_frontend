...
export interface FormValueType extends API.PartialServiceItemForm {
  target?: string;
  template?: string;
  type?: string;
  time?: string;
...
const UpdateForm: React.FC<UpdateFormProps> = (props) => {
  const [form] = Form.useForm<API.PartialServiceItemForm>();
  return (
    <ModalForm<API.PartialServiceItemForm>
      ...
      initialValues={{
        ...props.values,
        payload: JSON.stringify(props.values.payload, null, 2),
      }}
      clearOnDestroy
    >
